...
public record CreateModuleExamRequest(
    ...
    public CreateModuleExamRequest(UUID subjectModuleId, UUID classGroupId, LocalDate examDate, LocalTime startTime, LocalTime endTime, String location) {
        this(subjectModuleId, classGroupId, examDate, startTime, endTime, location, null, null);
    }

    public CreateModuleExamRequest(UUID subjectModuleId, UUID classGroupId, LocalDate examDate, LocalTime startTime, LocalTime endTime, String location, UUID roomId) {
