...
export function ExamPlanningWorkspace({ academicLevelId, academicYearId, establishmentId, modules, semesterId, semesterName, semesters, onSelectSemester }: Props) {
