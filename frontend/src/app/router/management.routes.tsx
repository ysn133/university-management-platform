  ...
  children: [
    { index: true, element: <ManagementOverviewPage /> },
    {
      ...
      children: [
        ...
        { path: "establishments/:establishmentId/departments/:departmentId/programs", element: <ProgramFilieresPage /> },
        { path: "establishments/:establishmentId/departments/:departmentId/programs/:programFiliereId", element: <ProgramCurriculumPage /> },
        { path: "establishments/:establishmentId/departments/:departmentId/programs/:programFiliereId/modules/:subjectModuleId", element: <SubjectModulePage /> },
        ...
        { path: "establishments/:establishmentId/degree-cycles/:degreeCycleId/programs", element: <ProgramFilieresPage /> },
        { path: "establishments/:establishmentId/degree-cycles/:degreeCycleId/programs/:programFiliereId", element: <ProgramCurriculumPage /> },
        { path: "establishments/:establishmentId/degree-cycles/:degreeCycleId/programs/:programFiliereId/modules/:subjectModuleId", element: <SubjectModulePage /> },
    ...
    },
    {
      ...
      children: [
        ...
        { path: "departments/:departmentId/programs", element: <ProgramFilieresPage /> },
        { path: "departments/:departmentId/programs/:programFiliereId", element: <ProgramCurriculumPage /> },
        { path: "departments/:departmentId/programs/:programFiliereId/modules/:subjectModuleId", element: <SubjectModulePage /> },
        ...
        { path: "degree-cycles/:degreeCycleId/programs", element: <ProgramFilieresPage /> },
        { path: "degree-cycles/:degreeCycleId/programs/:programFiliereId", element: <ProgramCurriculumPage /> },
        { path: "degree-cycles/:degreeCycleId/programs/:programFiliereId/modules/:subjectModuleId", element: <SubjectModulePage /> },
