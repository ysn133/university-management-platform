...
export function ProfessorClassPage() {
  ...
  const returnPath = returnContext === "grades" ? "/professor/grades" : returnContext === "exams" ? "/professor/exams" : `/professor/modules/${subjectModuleId}`;
  const returnLabel = returnContext === "grades" ? "Back to Grades" : returnContext === "exams" ? "Back to Exam Schedule" : "Back to module classes";
