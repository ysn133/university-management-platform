...
export function ProfessorTeachingDetailsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"schedule" | "students" | "attendance">(searchParams.get("tab") === "attendance" ? "attendance" : "schedule");
